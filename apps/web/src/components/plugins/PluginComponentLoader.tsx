  ...
  useEffect(() => {
    ...
    const loadComponent = async () => {
      try {
        ...
        const LoadedComponent = module.default || module.Component || Object.values(module).find(v => typeof v === 'function');
        
        if (!LoadedComponent) {
            throw new Error('El módulo de plugin no exporta un componente válido (default o función).');
        }
