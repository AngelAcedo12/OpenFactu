...
export const PreviewPane: React.FC<Props> = ({ previewUrl, previewing, onRefresh }) => (
 <Card
 className="h-full border-slate-100 dark:border-slate-800 bg-slate-50 dark:bg-slate-800/50" noPadding
 ...
 <iframe
 src={previewUrl}
 title="Vista previa PDF" style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', border: 0 }}
 />
 ) : (
