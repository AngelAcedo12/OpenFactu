...
export const PrintTemplateButton: React.FC<Props> = ({ docType, pdfUrl, label = 'Descargar PDF', className }) => {
 ...
 <p className="text-[10px] font-black uppercase tracking-wider text-slate-500 dark:text-slate-400 dark:text-slate-500">Elige una plantilla</p>
 </div>
 ...
 <span className="flex-1 text-sm text-slate-700 dark:text-slate-200 truncate">{t.name}</span>
 {t.isDefault && (
