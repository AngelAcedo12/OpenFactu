  ...
  return (
    <div className="min-h-screen bg-slate-50 p-8 space-y-12 pb-24">
      <header className="max-w-5xl mx-auto">
        <h1 className="text-4xl font-bold text-slate-900">ERP Design System</h1>
        <p className="text-slate-500 mt-2">Librería de componentes genéricos para OpenFactu.</p>
      </header>
      ...
      <main className="max-w-5xl mx-auto space-y-12">
        ...
        <Card title="Cargadores (Loaders)" subtitle="Indicadores de progreso y estados de espera.">
          <div className="flex flex-wrap items-end gap-10">
            <div className="flex flex-col items-center gap-2">
                <Loader size="sm" />
                <span className="text-[10px] text-slate-400 font-mono">sm</span>
            </div>
            <div className="flex flex-col items-center gap-2">
                <Loader size="md" />
            ...
            <div className="flex flex-col items-center gap-2">
                ...
                <span className="text-[10px] text-slate-400 font-mono">lg</span>
            </div>
            <div className="flex flex-col items-center gap-2">
                <Loader size="xl" label="Procesando..." />
                <span className="text-[10px] text-slate-400 font-mono">xl</span>
            </div>
            <div className="flex flex-col items-center gap-2">
                <Button onClick={() => {
        ...
        <Card title="Notificaciones (Toasts)" subtitle="Avisos dinámicos en la esquina superior derecha.">
          <div className="flex flex-wrap gap-4">
            ...
            <Button onClick={() => toast.error('Ha ocurrido un error inesperado')} variant="secondary" className="bg-rose-50 text-rose-700 border-rose-200 hover:bg-rose-100">
                Lanzar Error
            </Button>
            <Button onClick={() => toast.warning('Tu suscripción está por expirar')} variant="secondary" className="bg-amber-50 text-amber-700 border-amber-200 hover:bg-amber-100">
                Lanzar Aviso
            </Button>
            <Button onClick={() => toast.info('Nueva actualización disponible')} variant="secondary" className="bg-blue-50 text-blue-700 border-blue-200 hover:bg-blue-100">
                Lanzar Info
            </Button>
          </div>
        </Card>
