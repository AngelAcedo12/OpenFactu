...
export const AccountingPeriods: React.FC = () => {
 ...
 {  header: 'Estado',  cell: (c: any) => c.status === 'O'  ? <Badge variant="success">Abierto</Badge>  : <Badge variant="neutral">Cerrado</Badge>
 },
 ...
 <p className="text-slate-500 dark:text-slate-400 dark:text-slate-500 mt-1 font-medium">Define los ejercicios o años fiscales para acotar la contabilidad y series.</p>
 </div>
 ...
 <Input  placeholder="Code (Ej: 2024)" value={code}
 onChange={(e) => setCode(e.target.value)}
 required
 />
 </div>
 <div className="flex-[2]">
 <Input  placeholder="Nombre (Ej: Ejercicio 2024)" value={name}
 ...
 <Button type="submit"disabled={isSubmitting || !canWrite} className="flex items-center gap-2 disabled:opacity-50 disabled:grayscale transition-all">
