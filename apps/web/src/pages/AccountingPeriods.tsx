...
export const AccountingPeriods: React.FC = () => {
  ...
  const columns = [
    ...
    { 
      header: 'Inicio', 
      cell: (c: any) => new Date(c.startDate).toLocaleDateString()
    },
    { 
      header: 'Fin', 
      cell: (c: any) => new Date(c.endDate).toLocaleDateString()
    },
    { 
      header: 'Estado', 
      cell: (c: any) => c.status === 'O' 
  ...
  return (
    <div className="p-8 max-w-5xl mx-auto space-y-8 animate-in fade-in duration-500">
      <div>
        ...
        <p className="text-slate-500 mt-1 font-medium">Define los ejercicios o años fiscales para acotar la contabilidad y series.</p>
      </div>
