...
import { Eye, EyeOff, Database, User, Building, ChevronRight, ChevronLeft, CheckCircle2 } from 'lucide-react';
    ...
    try {
      const response = await fetch('/api/setup/init', {
        ...
        body: JSON.stringify({
           ...
           company: { name: formData.companyName, nif: formData.companyNif }
        })
      });
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8">
        <div className="mb-8 text-center">
          <h1 className="text-3xl font-extrabold text-blue-600">OpenFactu</h1>
